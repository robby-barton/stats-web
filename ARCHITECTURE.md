...
src/client/team.tsx
  └─ components/teamCard.tsx
       ├─ components/teamChart.tsx       (rank history chart via amcharts5)
...
| Path                           | Generated By             |
|--------------------------------|--------------------------|
| `/ranking/{division}/{year}/{week}/` | `src/ranking/` + pagination over `rankingPaths` |
| `/team/{teamId}/`              | `src/team/` + pagination over `teamPaths`       |
